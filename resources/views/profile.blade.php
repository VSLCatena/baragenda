                                ...
                                @foreach($committees as $k => $c)
                                    <div class="row">
                                        <div class="offset-1 col-8"   >
                                            <a class="" href="mailto:{{ $c->name ?? '' }}" data-bs-toggle="tooltip" data-bs-html="true" data-bs-placement="right" title="@foreach($c->infos as $u=>$i)<i>{{$i->name}}</i><br/>@endforeach" >{{ $c->name ?? '' }}
                                            </a>
                                        </div>
                                    </div>
                                @endforeach
